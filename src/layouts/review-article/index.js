...
export default function ReviewArticle() {
  ...
  useEffect(() => {
    ...
    if (id) {
      fetchWrapper.get(`${process.env.REACT_APP_API_BASE}/articles/${articleId}`).then((res1) => { setArticle(res1); console.log('oukej'); }).catch(console.log('api error'));
      fetchWrapper.get(`${process.env.REACT_APP_API_BASE}/articles/${articleId}/claims`).then((res2) => {
        ...
        setClaims(res2); console.log('oukej');
